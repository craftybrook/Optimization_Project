...
def main():
    ...
    #oc2 = oc(origami_filepath="C:\\Users\\thetk\\Documents\\BYU\\CMR Labs\\Origami_Sensitivity_Analysis\\Origami_Sensitivity_Analysis\\pattern_files\\sample-color-svgrepo-com.svg", verbose=True)
